...
function save(req, res) {
    ...
    query = connect.con.query('INSERT INTO operations_managers SET ?', post, function(err, rows, fields) {
...
function update(req, res) {
    ...
    query = connect.con.query('INSERT INTO operations_managers SET manager_id = ?, birth_date =?, rating=?, phone_number =?, email =?, distance_from_scene =?, availability =?, where manager_id=?', update, function(err, rows,
        fields) {
        console.log(query.sql);
        if (!err) {
...
function deleteID(req, res) {
    ...
    connect.con.query('DELETE from operations_managers where manager_id = ?', post, function(err, rows, fields) {
        if (!err) {
