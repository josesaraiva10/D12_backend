...
function addRow(data) {
    ...
    let query = mysql.format(insertQuery,["Ocurrences","ocurrence_id","start_date","end_date","status", "local", "evaluation", "access_code", "fk_Occ_manager_id", "fk_Occ_team_id",data.ocurrence_id,data.start_date,data.end_date, data.status, data.local, data.evaluation, data.access_code, data.fk_Occ_manager_id, data.fk_Occ_team_id]);
...
function updateRow(data) {
    ...
    let query = mysql.format(updateQuery,["Ocurrences","        !password",data.password,"ocurrence_id",data.ocurrence_id]);
...
function queryRow(userName) {
    ...
    let query = mysql.format(selectQuery,["Ocurrences","ocurrence_id",      !userName]);
...
function deleteRow(userName) {
    ...
    let query = mysql.format(deleteQuery, ["Ocurrences", "ocurrence_id",        !userName]);
