...
function addRow(data) {
    ...
    let query = mysql.format(insertQuery,["collaborators", "collaborators_id", "name", "birth_date", "gender", "nif","phone_number", "adress", "fk_collaborators_user_id", data.collaborators_id,data.name,data.birth_date, data.gender, data.nif, data.phone_number, data.adress, data.fk_collaborators_user_id]);
...
function updateRow(data) {
    ...
    let query = mysql.format(updateQuery,["Collaborators","password",data.password,"collaborators_id",data.collaborators_id]);
...
function queryRow(userName) {
    ...
    let query = mysql.format(selectQuery,["Collaborators","collaborators_id", userName]);
...
function deleteRow(userName) {
    ...
    let query = mysql.format(deleteQuery, ["Collaborators", "collaborators_id", userName]);
